...
https://www.cssscript.com/confirmation-modal-confirmo/
 */
...
document.getElementById('confirmo-modal').innerHTML = '<center>'
    + '<div class="confirmo-modal">'
    + '<p align="right">'
    + '<button class="confirmo-close" onclick="closeconfirmomodal()">&times;</button></p><div id="confirmo-content"></div><div class="confirmo-controls"><button type="button"  id="confirmo-left" class="confirmo-btn" > CONFIRMAR</button><button id="confirmo-right" class="confirmo-btn" onclick="closeconfirmomodal()"> CANCELAR</button></div>'
    + '</div>'
    + '</center>';
