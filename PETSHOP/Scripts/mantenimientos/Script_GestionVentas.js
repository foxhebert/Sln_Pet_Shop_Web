...
/////////////////////////////////////////////////////////////////////////////////
 $(document).ready(function () {
     ...
     ListarGestionVentas(par = "NORMAL");  //Cargar El Listado Principal de Compras
     ...
     $('#fx_13_02_22_menu_actual').html('VENTAS o SALIDAS');
                ...
                //content.innerHTML = ;
                    ...
                    { ObjProducto: Producto, objSession: SesionMovi, intTipoOperacion: 1 },
                        (response) => {
                            ...
                            ListarGestionVentas(par = "NORMAL");
...
$('#btn-update-COMPRA').on('click', function () {
    ...
    var _intIdCompra         = let_intIdVentaGesVen;
    var _strCodigoCompra     = $("#val_strCodigoCompra").val();
    var _intIdProducto       = let_intIdProductoGesCom;
    var _strCodigoProducto   = $("#val_strCodigoProducto").val();
    var _intCantIngresada    = $("#val_intCantIngresada").val();
...
$("#inputBuscadorCodBarras").on("keyup", function () {
    ...
    $('.val_spanProItem').html($.trim($("#inputBuscadorCodBarras").val())); //77777
...
let data_compras = [];
function ListarGestionVentas( par = "NORMAL" ) {
    ...
    if (par == "RELOAD") {
        ...
        $('#inputBuscarPorTexto').val('');
        $('.div_spanProItem').hide();
        //alert("function ListarGestionarProductos(2)");
        strCodigoBarras_ = "";
    ...
    //$('.titulo-form-rigth').html("Información de Compra a Editar");

    $.post(
        '/Procesos/ListarVentasGesVen',
        {
        ...
        response => {
            ...
            _varTablaList_Compras = $('#tabla_gestion_ventas').DataTable({
                    ...
                    [   
                        ...
                        //{ data: 'intIdVentaCabe' },
                        {
                            ...
                            "render": (data, type, item, meta) => {      
                                ...
                                return `<span  style  = "color:#337ab7; white-space: nowrap; font-weight: 800; width: 99%;text-align: justify; padding:0px 15px 0px 0px;" 
                                               >` + data + `</span>`;
                        ...
                        { data: 'decPrecUnitDeVenta' },
                        { data: 'intCantidadDeVenta' },
                        { data: 'decMontoTotDeVenta' },
                        { data: 'decCostoUnitCompra' },
                        { data: 'decMontoGanancia' },
                        { data: 'dttDateTimeInserted' },
                        { data: 'dttDateTimeUpdated' },
                        //{ data: 'dttDateTimeUpdated' },

                        {
                            sortable: false,
                            "render": (data, type, item, meta) => {
                                let intIdComp = item.intIdVenta;
                                return `<button class="btn btn-success btn-xs btn-ver d-flex" dataid="${intIdComp}" hidden><i class="fa fa-eye"></i></button>` +
                                    `<button class="btn btn-success btn-xs btn-edit-compra d-flex" dataid="${intIdComp}" hidden><i class="fa fa-pencil"></i>Editar</button>` +
                ...
                columnDefs: [ //ocultar y definir columnas
                    {
                        ...
                        visible: true,
                        searchable: true,
                        width: "6%", //setear el ancho de la columna en px
                    ...
                    },
                    {
                        ...
                        visible: true,
                        searchable: true,
                        width: "8%" , //setear el ancho de la columna en px
                        className: "text-center"
                    },
                    {
                        targets: [2],
                        visible: true,
                        searchable: true,
                        width: "5%", //setear el ancho de la columna en px
                        className: "text-center"
                    },
                    //{
                    //    targets: [3],
                    ...
                    //},
                    {
                        ...
                        visible: true,
                        searchable: true,
                        width: "4%", //setear el ancho de la columna en px
                        className: "text-center"
                    },
            ...
            $("#tabla_gestion_ventas_filter").hide();
...
let let_intIdVentaGesVen;
//BOTON EDITAR REGISTRO DEL LISTADO - EDITAR COMPRA
$('#tabla_gestion_ventas  tbody').on('click', 'tr button.btn-edit-compra', function () {

    let edit_id = $(this).attr("dataid");
    if (!isNaN(edit_id)) {
        CargarCompraParaEditar(edit_id);
        let_intIdVentaGesVen = edit_id; //Mantener en esta variable el ID
...
//BOTON EDITAR CON FUNCION CARGAR COMPRAS
//Cargar Producto por PK a formulario de inputs dinámicos 
function CargarCompraParaEditar(intIdCompra_) {
    ...
    $('.titulo-form-left').html("Producto Asociado a Ingreso de Compra.");
    //$('.titulo-form-left').html("Información de Producto Comprado");
    ...
    $.post(
        ...
        (response) => {
            ...
            response.forEach(element => {
                ...
                $('#divCodbar').removeClass("divCodbar"); //55555 divCodbarInput
                $('#inputCapturarCodigoBarras').addClass("CodbarInputDefault"); 

                let_intIdProductoGesCom = element.intIdProducto; ///9999999
                //alert(let_intIdProductoGesCom);
                let_intIdVentaGesVen = element.intIdCompra;
...
$('#tag_remove').on('click', function () {
    ...
    if ($('.backgroundLayerOpaque').is(":visible") ==  false) {
        ...
        $('#divCodbar').addClass("divCodbar"); //55555 divCodbarInput
...
$('#btnRegistrarNuevoIngreso').on('click', function () {  //#btnRegistrarNuevaCompraModal
    ...
    //$('body').css('overflow-y', 'hidden');  5555
