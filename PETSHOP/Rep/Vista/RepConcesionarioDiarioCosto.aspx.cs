    ...
    public partial class RepConcesionarioDiarioCosto : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            using (proxyRep = new ReportesSrvClient())
            {
                try
                {
                    list = proxyRep.ReporteDiarioConcesionaria(objSession, listEmpleados.ToArray(), int.Parse(intConcesionaria), filtrojer_ini, filtrojer_fin, ref strMsgUsuario, int.Parse(intTipoServicio), int.Parse(intTipoMenu), int.Parse(intMarcador)).ToList();
