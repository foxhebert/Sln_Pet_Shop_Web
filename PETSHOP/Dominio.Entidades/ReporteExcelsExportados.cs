...
{
    public class ReporteExcelsExportados
    {
         //PARA EL CRYSTAL REPORT
         ...
         [DataMember] public string CodEmpleado  { get; set; } //---> Añadido solo para TBBIENESDS
         [DataMember] public string DesEmpleado  { get; set; }//TBEMPLEADO
         [DataMember] public string DesEstado    { get; set; }//TBOFICINA
         ...
         //CRYSTAL Y PDF REPORT DE TBOFICINA Y TBEMPLEADOS
